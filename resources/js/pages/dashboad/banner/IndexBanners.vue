...
import AddBannerModal from "./AddBannerModal.vue"
...
const getBanner = async (id) => {
    const response = await axios.get('/api/get_banner/' + id)
...
const deleteBanner =  (bannerId) => {
  Swal.fire({
        ...
        if (result.value) {
            axios.get("/api/delete_banner/" + bannerId).then(() => {
                                                ...
                                                <div class="overflow-auto xl:overflow-visible">
                                                    <table data-tw-merge="" class="w-full text-left border-b border-slate-200/60">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr data-tw-merge="" class="[&_td]:last:border-b-0" v-for="banner in banners" :key="banner.id">
                                                              
                                                                <td data-tw-merge="" class="px-5 border-b dark:border-darkmode-300 border-dashed py-4 dark:bg-darkmode-600">
                                                                    <div class="flex items-center">
                                                                        <div class="image-fit zoom-in h-9 w-9">
                                                                            <img data-placement="top" title="Meryl Streep" :src="'/storage/' + banner.image" alt="Photo" class="tooltip cursor-pointer rounded-full shadow-[0px_0px_0px_2px_#fff,_1px_1px_5px_rgba(0,0,0,0.32)] dark:shadow-[0px_0px_0px_2px_#3f4865,_1px_1px_5px_rgba(0,0,0,0.32)]">
                                                                        </div>
