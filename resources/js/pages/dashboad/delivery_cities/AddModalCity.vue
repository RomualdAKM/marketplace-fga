...
const saveCity = async () => {
    ...
    formData.append("city_price", form.city_price);
    formData.append("country_id", form.country_id);


    await axios.post("/api/save_city", formData).then((response) => {
    ...
    <div data-tw-backdrop="" aria-hidden="true" tabindex="-1" id="header-footer-modal-preview"
        ...
        <div data-tw-merge
            ...
            <div data-tw-merge class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                <div class="col-span-12 sm:col-span-12" v-if="countries">
                    <label data-tw-merge for="modal-form-1"
                        class="inline-block mb-2 group-[.form-inline]:mb-2 group-[.form-inline]:sm:mb-0 group-[.form-inline]:sm:mr-5 group-[.form-inline]:sm:text-right">
                        Selectionné pays
                    </label>

                    <select id="category" v-model="form.country_id"
                ...
                <div class="col-span-12 sm:col-span-12">
                    ...
                    <input data-tw-merge id="modal-form-1" v-model="form.city_name" type="text"
                ...
                <div class="col-span-12 sm:col-span-12">
                    ...
                    <input data-tw-merge id="modal-form-1" v-model="form.city_price" type="number" min="1"
            ...
            <div class="px-5 py-3 text-right border-t border-slate-200/60 dark:border-darkmode-400">
                ...
                <div v-else>
                    ...
                    <button @click="saveCity()" type="button"
